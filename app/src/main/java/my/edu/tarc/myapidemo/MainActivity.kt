...
import my.edu.tarc.myapidemo.api.RetrofitInstance
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnGet.setOnClickListener(){
            val call = RetrofitInstance.api.getAllStudent()
        ...
        btnLoad.setOnClickListener(){
            val call = RetrofitInstance.api.getById("W666")
            call.enqueue(object : Callback<StudentRespond>{
                override fun onResponse(
                    ...
                    Glide.with(img.context).load(rs!!.imgURL)
                }
